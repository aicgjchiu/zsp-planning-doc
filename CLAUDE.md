...
- **Display-name standard (Spiria / Corrupia):** the player's spiritual-energy resource (the "mana" stat) is always **Spiria** (靈能) in player-facing UI / design docs — never "Mana", "Soul Power", or "spirit energy". The corrupt / mutant power (enemy / corruption theme) is **Corrupia** (異能). The Daoshi's Q ability is **Spiria Bullet**. Apply going forward; don't invent synonyms.
