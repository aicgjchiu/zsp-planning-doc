...
window.GANTT = [
  ...
  { who: 'Artist · Environment', role: 'env', bars: [
    { name: 'Hamlet 靜村 concept + greybox',      start: 0,  end: 1,  color: 'env' },
    { name: 'Hamlet 靜村 final dress',            start: 1,  end: 3,  color: 'env' },
    { name: 'Monastery 雪山 concept → build',     start: 2,  end: 5,  color: 'env' },
    { name: 'Bayou 瘴氣沼澤 concept → build',     start: 4,  end: 7,  color: 'env' },
    { name: 'Steppe 無盡草原 concept → build',    start: 6,  end: 9,  color: 'env' },
...
window.TASKS = {
  ...
  env: [
    { phase:1, p:'P0', title:'Hamlet 靜村 concept art',            body:'6 keyframes: dusk paddies, shrine gate, inner alley, central altar, bell tower, boss arena.' },
    { phase:1, p:'P0', title:'Hamlet 靜村 greybox',                body:'Playable block-out; Portal can spawn at 8+ valid points with clean line of sight.' },
    { phase:2, p:'P0', title:'Hamlet 靜村 final dress',            body:'Modular kit: huts, fences, lanterns, paddy plane. 1.2M tri budget.' },
    { phase:2, p:'P0', title:'Monastery 雪山 concept + greybox',   body:'Indoor/outdoor split; chapel as the boss arena.' },
    { phase:3, p:'P0', title:'Monastery 雪山 final dress',         body:'Stone modular kit + snow shader; chapel interior set dressing.' },
    { phase:3, p:'P0', title:'Bayou 瘴氣沼澤 concept + greybox',   body:'Water plane + walkable islands; rope-bridge rig.' },
    { phase:4, p:'P0', title:'Bayou 瘴氣沼澤 final dress',         body:'Swamp foliage, skiffs, bone totems, hanging vines.' },
    { phase:4, p:'P0', title:'Steppe 無盡草原 concept + greybox',  body:'Open terrain + ruined shrine; day/night lighting presets.' },
    { phase:5, p:'P0', title:'Steppe 無盡草原 final dress',        body:'Grass groom, ruined shrine, Khan statue.' },
